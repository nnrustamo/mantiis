...
plt.figure()
plt.plot(np.arange(len(conv_sg_2mpa)), conv_sg_2mpa,  color='red', label='Single-block')
plt.plot(np.arange(len(conv_mg_2mpa)), conv_mg_2mpa,  color='black', label='Multi-block')
plt.legend()
plt.yscale('log')
...
line1, = ax1.plot(inv_P, k_sg, marker='o', color='red', label='Single-block')
line2, = ax1.plot(inv_P, k_mg, marker='s', color='black', label='Multi-block')
