...
def plot_runtime(threads):
    ...
    plt.plot(mg_true['Nx'], mg_true['Time Per Iteration (s)']*1000, label='multi-grid', color='black', marker='o', markersize=6)
    plt.plot(mg_false['Nx'], mg_false['Time Per Iteration (s)']*1000, label='single-grid', color='red', marker='D', markersize=6)
